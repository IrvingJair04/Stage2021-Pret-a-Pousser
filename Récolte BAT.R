read.delim("C:/Users/Irving Arcia/Desktop/Rapport de stage/txt/Récolte BAT.txt", 
           header = TRUE)

dta <- read.delim("C:/Users/Irving Arcia/Desktop/Rapport de stage/txt/Récolte BAT.txt", 
                  header = TRUE)
...
ggboxplot(dta, x = "Engrais", y = "Masse.fraiche",
          ...
          width = 0.3,
          outlier.shape = 21) + 
  stat_compare_means(comparisons = my_comparisons, label.y = c(190, 210, 230),
