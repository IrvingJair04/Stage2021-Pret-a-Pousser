read.delim("C:/Users/Irving Arcia/Desktop/Rapport de stage/txt/Chlorophylle MOU.txt", header = TRUE)

dta <- read.delim("C:/Users/Irving Arcia/Desktop/Rapport de stage/txt/Chlorophylle MOU.txt", header = TRUE)
...
ggboxplot(dta, x = "Engrais", y = "Chlorophylle",
          ...
          width = 0.3,
          outlier.shape = 21) + 
  stat_compare_means(comparisons = my_comparisons, label.y = c(0.6, 0.7, 0.80),
