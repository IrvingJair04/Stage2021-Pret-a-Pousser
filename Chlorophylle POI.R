read.delim("C:/Users/Irving Arcia/Desktop/Rapport de stage/txt/Chlorophylle POI.txt", header = TRUE)

dta <- read.delim("C:/Users/Irving Arcia/Desktop/Rapport de stage/txt/Chlorophylle POI.txt", header = TRUE)
